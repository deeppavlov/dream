...
rm -r dialog_data
python3 skills/tfidf_retrieval/data/data_maker.py --ratings_file=ratings/ratings.csv --dialogs_file=dialogs --output_file=skills/tfidf_retrieval/data/dialog_list.json --bad_output_file=skills/tfidf_retrieval/data/bad_dialog_list.json --assessment_file=skills/tfidf_retrieval/data/conversation_assessment.csv --good_poor_phrase_file=skills/tfidf_retrieval/data/goodpoor.json
