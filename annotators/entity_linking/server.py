...
GENRES_TEMPLATE = re.compile(r"(\brock\b|heavy metal|\bjazz\b|\bblues\b|\bpop\b|\brap\b|hip hop\btechno\b"
                             r"|dubstep|classic)")
SPORT_TEMPLATE = re.compile(r"(soccer|football|basketball|baseball|tennis|mma|boxing|volleyball|chess|swimming)")

genres_dict = {"rock": "Q11399", "heavy metal": "Q38848", "jazz": "Q8341", "blues": "Q9759", "pop": "Q37073",
               "rap": "Q6010", "hip hop": "Q6010", "techno": "Q170611", "dubstep": "Q20474", "classic": "Q9730"}

sport_dict = {"soccer": "Q2736", "football": "Q2736", "basketball": "Q5372", "baseball": "Q5369", "tennis": "Q847",
              "mma": "Q114466", "boxing": "Q32112", "volleyball": "Q1734", "chess": "Q718", "swimming": "Q31920"}
...
def extract_topic_skill_entities(utt, entity_substr_list, entity_ids_list):
    ...
    if found_genres:
        ...
        if all([genre not in elem for elem in entity_substr_list]) \
                or all([genre_id not in entity_ids for entity_ids in entity_ids_list]):
            found_substr = genre
            found_id = genre_id
    ...
    if found_sport:
        ...
        if all([sport not in elem for elem in entity_substr_list]) \
                or all([sport_id not in entity_ids for entity_ids in entity_ids_list]):
            found_substr = sport
            found_id = sport_id
...
def respond():
    ...
    try:
        ...
        entity_info_batch = []
        for entity_substr_list, entity_ids_list, conf_list, entity_pages_list, context in \
                zip(entity_substr_batch, entity_ids_batch, conf_batch, entity_pages_batch, short_context_batch):
            entity_info_list = []
