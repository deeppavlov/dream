...
from torch_transformers_preprocessor import TorchTransformersEntityRankerPreprocessor
...
class TorchTransformersEntityRankerInfer:
    ...
    def __call__(
        ...
        for entity_emb, candidate_entities_list, candidate_entities_descr_list in zip(
            entity_emb_batch, candidate_entities_batch, candidate_entities_descr_batch
        ):
