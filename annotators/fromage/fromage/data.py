...
def get_dataset(args, split: str, tokenizer, precision: str = "fp32") -> Dataset:
    assert split in ["train", "val"], 'Expected split to be one of "train" or "val", got {split} instead.'
        ...
        while True:
            ...
            try:
                ...
                cap_img = utils.create_image_of_text(
                    decode_caption.encode("ascii", "ignore"), width=self.image_size, nrows=2, font=self.font
                )
