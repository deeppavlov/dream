...
def main_test():
    ...
    configs = [{'sentences': ['i love you', 'i hate you', 'i dont care'], 'task': 'sentiment_classification',
               ...
               {'sentences': ["let's talk about movies"], 'task': 'cobot_dialogact_topics',
                'answers': [['Entertainment_Movies']]},
               {'sentences': ["let's talk about games"], 'task': 'cobot_topics',
                'answers': [['Games']]},
               {'sentences': ["let's switch topic"], 'task': 'cobot_dialogact_intents',
                'answers': [['Topic_SwitchIntent']]}
               ]
