...
templates = []
templates += [(re.compile(r"won't", flags=re.IGNORECASE), "will not")]
templates += [(re.compile(r"\bcant\b", flags=re.IGNORECASE), "can't")]
templates += [(re.compile(r"\bim\b", flags=re.IGNORECASE), "i'm")]
