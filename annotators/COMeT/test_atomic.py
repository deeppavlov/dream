...
def main():
    ...
    request_data = {"input": "PersonX went to a mall",
    ...
    gold_result = {
        ...
        'xAttr': {
            ...
            'effect_type': 'xAttr', 'event': 'PersonX went to a mall'
        },
        'xIntent': {
        ...
        'xReact': {
            ...
            'effect_type': 'xReact', 'event': 'PersonX went to a mall'
        },
        'xWant': {
            'beams': ['to buy something', 'to go home', 'to shop'],
            'effect_type': 'xWant', 'event': 'PersonX went to a mall'
        }
    }
