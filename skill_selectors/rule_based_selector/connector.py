...
class RuleBasedSkillSelectorConnector:
    async def send(self, payload: Dict, callback: Callable):
        ...
        try:
            ...
            if ALWAYS_TURN_ON_ALL_SKILLS or user_uttr["attributes"].get(
            ...
            if "/new_persona" in user_uttr_text:
                ...
                is_sensitive_topic_and_request(user_uttr)
            ...
            ranged_prompts = user_uttr_annotations.get("prompt_selector", {}).get(
                "prompts", []
            )
            if ranged_prompts:
