...
| Combined Classification lightweight    | 1.6 Gb RAM, 0.9 Gb GPU | The same model as Combined Classification, but takes 42% less time thanks to the lighter backbone              |
