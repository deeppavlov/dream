...
| DFF Short Story skill         | 65 MiB RAM                 | **[New DFF version]** tells two types of stories: 1) a short story on a given topic if directly asked 2) a short story using keywords if there are not less than 5 keywords found in the last two utterances       |                                          |
