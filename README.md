...
| Rake keywords                 | 70 MiB RAM               | extracts keywords from utterances with the help of RAKE algorithm                                                                                                   |
...
| StoryGPT                 | 1.7 GiB RAM, 2.15 GiB GPU  | generative service based on fine-tuned GPT-2, for the given set of keywords returns a short story using the keywords                        |
| Prompt StoryGPT                 | 1.7 GiB RAM, 4 GiB GPU  | generative service based on fine-tuned GPT-2, for the given topic represented by one noun returns short story on a given topic                         |
...
| DFF Short Story skill         | 90 MiB RAM                 | **[New DFF version]** tells two types of stories: 1) a short story on a given topic if directly asked 2) a short story using keywords if there are not less than 5 keywords found in the last two utterances       |                                          |
