...
| Program Y                 | req | Chatbot Program Y (https://github.com/keiffster/program-y) adapted for Dream socialbot                                                                                                           |
| Program Y Dangerous       | req | Chatbot Program Y (https://github.com/keiffster/program-y) adapted for Dream socialbot, containing responses to dangerous situations in a dialog                                                 |
| Program Y Wide            | req | Chatbot Program Y (https://github.com/keiffster/program-y) adapted for Dream socialbot, and including only very general templates (with lower confidence)                                        |
...
| DFF Book skill            | req | detects book titles and authors mentioned in the user's utterance with the help of the Wiki parser and Entity linking and recommends books by leveraging information from the GoodReads database |
...
| DFF Coronavirus skill     | req | retrieves data about the number of coronavirus cases and deaths in different locations from the sources of the John Hopkins University Center for System Science and Engineering                 |
...
| DFF Funfact skill         | req | constructed with DFF to tell user fun facts when one asked for them                                                                                                                              |
...
| DFF Grounding skill       | req | DFF-based skill to answer what is the topic of the conversation, to generate acknowledgement, to generate universal responses on some dialog acts by MIDAS                                       |
...
| DFF Short Story skill     | req | tells user short stories from 3 categories: (1) bedtime stories, such as fables and moral stories, (2) horror stories, and (3) funny ones                                                        |
| DFF Sports Skill          | req | DFF-based skill to discuss sports                                                                                                                                                                |
| DFF Travel skill          | req | DFF-based skill to discuss travel                                                                                                                                                                |
| DFF Weather skill         | req | uses the OpenWeatherMap service to get the forecast for the user's location                                                                                                                      |
