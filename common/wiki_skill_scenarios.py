...
topic_config = \
    {"hobbies":
     {"switch_on": [{"cond": [[[{"pattern": DFF_WIKI_LINKTO["hobbies"]}, "bot", True], ["is_yes", "user", True]],
      ...
      "expected_subtopic_info": [{"subtopic": "user_has_hobbies",
                                 ...
                                 {"subtopic": "user_mentioned_hobbies",
                                  "cond": [[[{"pattern": DFF_WIKI_LINKTO["hobbies"]}, "bot", False]],
                                           [[{"pattern": HOBBIES_RE}, "user", True]]]}],
      "smalltalk": [{"utt": ["Do you have any hobbies?"],
                     "subtopic": "user_mentioned_hobbies",
                     "expected_subtopic_info": [{"subtopic": "user_has_hobbies",
                    ...
                    {"utt": ["Recently I found some life hacks and I think "
                     ...
                     "facts": [{"wikihow_page": "Use-Life-Hacks",
                                "cond": [["is_yes", "user", True]]}]},
                    ...
                    {"utt": ["Cool! I also like {user_hobby}!", "How long have do you have this hobby?"],
                     "subtopic": "user_has_hobbies",
                     "next_ackn": [{"cond": [[{"pattern": r"(year|long)"}, "user", True]],
                    ...
                    {"utt": ["Seems like for you it is more than a hobby."],
                     "subtopic": "user_has_hobbies"},
                    {"utt": ["Oh, so you completely change the area of your activity when doing your hobby.",
                             "It's incredible!", "Do you want to know how to improve your skills with hobbies?"],
                     "subtopic": "user_separate_hobby",
                     "facts": [{"wikihow_page": "Increase-Your-Skills-with-Hobbies",
                                "cond": [["is_yes", "user", True]]}]}],
      "questions": [{"pattern": "(do|did) you have (a hobby|hobbies)",
     ...
     "friends": {"switch_on": [{"cond": [[[{"pattern": DFF_WIKI_LINKTO["friends"]}, "bot", True],
                                          ["is_yes", "user", True]],
                                         [[{"pattern": DFF_WIKI_LINKTO["friends"]}, "bot", True],
                                          [{"pattern": DFF_WIKI_TEMPLATES["friends"]}, "user", True]]]}
                               ],
                 "pattern": DFF_WIKI_TEMPLATES["friends"],
                 "expected_subtopic_info": [{"subtopic": "has_friends",
                                             "cond": [[[{"pattern": DFF_WIKI_LINKTO["friends"]}, "bot", True],
                                                       ["is_yes", "user", True]],
                                                      [[{"pattern": "Do you have any friends?"}, "bot", True],
                                                       ["is_yes", "user", True]],
                                            ...
                                            {"subtopic": "not_has_friends",
                                             "cond": [[[{"pattern": DFF_WIKI_LINKTO["friends"]}, "bot", True],
                                                       ["is_no", "user", True]],
                                                      [[{"pattern": ANY_FRIEND_QUESTION}, "bot", True],
                                                       ["is_no", "user", True]],
                                                      [{"pattern": NO_FRIENDS_TEMPLATE}, "user", True]
                                                      ]},
                                            {"subtopic": "mentioned_friends",
                                             "cond": [[{"pattern": DFF_WIKI_TEMPLATES["friends"]}, "user", True]
                                                      ]}
                                            ],
                 "smalltalk": [{"utt": [ANY_FRIEND_QUESTION],
                                "subtopic": "mentioned_friends",
                                "expected_subtopic_info": [{"subtopic": "has_friends",
                                                            "cond": [["is_yes", "user", True]]},
                                                           {"subtopic": "not_has_friends",
                               ...
                               {"utt": ["Watching movies with your mates is perfect to share your feelings."
                                        "Would you like to watch any movie with your friends?"],
                                "subtopic": "has_friends",
                                "expected_subtopic_info": [{"subtopic": "asked_movie",
                                                            "cond": [["is_yes", "user", True]]}]},
                               {"utt": [WHAT_MOVIE_RECOMMEND],
                                "subtopic": "asked_movie"},
                               {"utt": ["Doing sports together is a good way to relax after a hard day.",
                               ...
                               {"utt": ["Do you have a friend who loves reading?"],
                                ...
                                "expected_subtopic_info": [
                                    {"subtopic": "asked_book", "cond": [["is_yes", "user", True]]}],
                                "next_ackn": [{"cond": [["is_yes", "user", True]],
                                               "answer": "Great! It's very nice to have a smart friend "
                                                         "with whom you can discuss your favourite book."}]},
                               {"utt": [WHAT_BOOK_RECOMMEND],
                                "subtopic": "asked_book"},
                               {"utt": "May I tell you how you can maintain a friendship?",
                                "subtopic": "has_friends",
                                "facts": [{"wikihow_page": "Maintain-a-Friendship",
                                           "cond": [["is_yes", "user", True]]}]},
                               {"utt": ["Although I am a socialbot, I know something about how you can make friends.",
     ...
     {"switch_on": [{"cond": [[[{"pattern": DFF_WIKI_LINKTO["art"]}, "bot", True], ["is_yes", "user", True]],
      ...
      "smalltalk": [{"utt": ["Drawing gives you a mean to self-reflect and externalize your emotions.",
                    ...
                    {"utt": ["Cool! Do you have any funny photos of your family or pets?"],
                     "subtopic": "photo",
                     "next_ackn": [{"cond": [["is_yes", "user", True]],
                                    "answer": "It's great to capture funny moments of your life."}]
                     },
                    ...
                    {"utt": ["Using Photoshop or Adobe Lightroom can help to increase the quality of pictures.",
                     ...
                     "subtopic": "photo",
                     "next_ackn": [{"cond": [["is_yes", "user", True]],
                                    "answer": "You are a very smart person!"}]},
                    ...
                    {"utt": ["I draw some memes with cats.", "Have you tried to draw a meme?"],
                     "subtopic": "memes",
                     "next_ackn": [{"cond": [["is_yes", "user", True]],
                                    "answer": "Great! You are a very creative person!"},
                                   {"cond": [["is_no", "user", True]],
                                    "answer": "It's never late to try!"}]},
     ...
     "family":
         {"pattern": DFF_WIKI_TEMPLATES["family"],
          "expected_subtopic_info": [{"subtopic": "help",
                                      "cond": [[{"pattern": r"help my " + DFF_WIKI_TEMPLATES["family"]},
                                                "user", True]]},
                                     ...
                                     {"subtopic": "family_mentioned",
                                      "cond": [[{"pattern": DFF_WIKI_TEMPLATES["family"]}, "user", True]]}],
          ...
          "smalltalk": [{"utt": ["Family provides love and support to us.",
                                 "Could you tell me more about your family?"],
                         "subtopic": "family_mentioned"},
                        {"utt": ["Lucky you! Your family is very close! Do you clean the house together?"],
                         "subtopic": "help"},
     ...
     "smartphones":
         {"switch_on": [
             {"cond": [[[{"pattern": DFF_WIKI_LINKTO["smartphones"]}, "bot", True], ["is_yes", "user", True]],
             ...
             "expected_subtopic_info": [{"subtopic": "android",
                                        ...
                                        {"subtopic": "apple",
                                         "cond": [[{"pattern": "ipone|ipod|apple"}, "user", True]]},
     ...
     "politics":
     {"switch_on": [{"cond": [[[{"pattern": DFF_WIKI_LINKTO["politics"]}, "bot", True], ["is_yes", "user", True]],
                              [{"pattern": DFF_WIKI_TEMPLATES["politics"]}, "user", True]]}],
      "pattern": DFF_WIKI_TEMPLATES["politics"],
      "expected_subtopic_info": [{"subtopic": "interested_in_politics",
                                  "cond": [[[{"pattern": DFF_WIKI_LINKTO["politics"]}, "bot", True],
                                            ["is_yes", "user", True]]]},  # yes to linkto
      ...
      "smalltalk": [{"utt": [DFF_WIKI_LINKTO["politics"]],
                     "expected_subtopic_info": [{"subtopic": "interested_in_politics",
                                                 "cond": [["is_yes", "user", True]]},
                                                {"subtopic": "not_interested_in_politics",
                                                 "cond": [["is_yes", "user", False]]}],
                     "subtopic": "mentioned_politics"},
                    {"utt": ["I like politics too! But as a socialbot I'm prohibited to talk about it much.",
                             "Still you can share your thoughts about it with me.",
                             "What type of political system does your country have?"],
                     "expected_entities": [{"name": "user_country_type",
                                            "wiki_parser_types": ["Q7278", "Q12047392"]},
                                           {"name": "user_country_type",
                                            "entity_substr": [["democracy", "democra"],
                     ...
                     "facts": [
                         ...
                         {"wikipedia_page": "Monarchy", "cond": [[{"pattern": "(monarch|king|queen|kingdom)"},
                                                                  "user", True]]},
                         {"wikipedia_page": "Authoritarianism", "cond": [[{"pattern": "authori"}, "user", True]]},
                         {"wikipedia_page": "Republicanism", "cond": [[{"pattern": "(republic|president)"},
                                                                       "user", True]]},
                    ...
                    {"utt": ["So, that's {user_country_type}. I see.",
                             "Do you like this political system?"],
                     "next_ackn": [{"cond": [["is_yes", "user", True]],
                                    "answer": "Wow! I also like it!"},
                                   {"cond": [["is_no", "user", True]],
                                    "answer": "I agree because I believe all systems have their own pros and cons."}],
                     "subtopic": "interested_in_politics"},
                    {"utt": ["Would you like to learn more about politics?"],
                     "expected_subtopic_info": [{"subtopic": "learn_more_about_politics",
                                                 "cond": [["is_yes", "user", True]]},
                                                {"subtopic": "not_interested_in_politics",
                                                 "cond": [["is_yes", "user", False]]}],
                     "subtopic": "interested_in_politics",
                    ...
                    {"utt": ["I also have learned recently about understanding politics.",
                             "Do you wanna know how to understand politics better?"],
                     "facts": [{"wikihow_page": "Understand-Politics",
                                "cond": [["is_yes", "user", True]]}],
                     "subtopic": "learn_more_about_politics"},
                    {"utt": ["I also have heard that interest to politics can be formed even in childhood.",
                             "Do you have kids?",
                             "Would you like me to tell you how to discuss politics with children?"],
                     "facts": [{"wikihow_page": "Discuss-Politics-With-Kids",
                                "cond": [["is_yes", "user", True]]}],
                     "subtopic": "learn_more_about_politics"},
                    {"utt": ["I see you are not interested.", "Although, I still can tell you something useful.",
                             "Do you wanna know how to politely avoid talking about politics?"],
                     "facts": [{"wikihow_page": "Avoid-Talking-Politics-at-Work",
                                "cond": [["is_yes", "user", True]]}],
                     "subtopic": "not_interested_in_politics"},
                    {"utt": ["Okay. I also know how to talk friendly about politics with anyone!",
                             "Would you like to hear?"],
                     "facts": [{"wikihow_page": "Discuss-Politics-in-a-Friendly-Setting",
                                "cond": [["is_yes", "user", True]]}],
                     "subtopic": "not_interested_in_politics"},
