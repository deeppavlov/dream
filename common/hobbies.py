...
HOBBIES_RE = re.compile(r"\b(Acroyoga|Acting|Aerial silk|Airbrushing|Amateur radio"
                        ...
                        "|Videography|Volunteering|Walking|Water sports|Zoo|Zoo visiting)\b", re.IGNORECASE)
