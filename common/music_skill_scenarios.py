from common.music import OPINION_REQUESTS_ABOUT_MUSIC, ASK_ABOUT_MUSIC, GENRES_TEMPLATE, \
    VARIOUS_GENRES_TEMPLATE, MUSIC_REQUEST_RE, MUSIC_TEMPLATE
...
topic_config = \
    {
        "music":
            {"switch_on": [{"cond": [[[{"pattern": music_linkto}, "bot", True],
                                      ["is_no", "user", False],
                                      [{"pattern": NOT_LIKE_PATTERN}, "user", False],
                                      [{"pattern": STOP_PATTERN}, "user", False]]],
                            "can_continue": "must", "conf": 1.0},
                           {"cond": [[{"wiki_parser_types": ["Q488205", "Q36834", "Q177220", "Q753110", "Q105756498",
                                                             "Q215380", "Q207628"]},
                                      "user", True],
             ...
             "expected_subtopic_info": [{"subtopic": "discuss_genre",
                                         "cond": [[{"pattern": GENRES_TEMPLATE}, "user", True]]},
                                        ...
                                        {"subtopic": "my_music",
                                         "cond": [[{"pattern": ASK_ABOUT_MUSIC},
                                                   "user", True]]},
                                        {"subtopic": "various_genres",
                                         "cond": [[{"pattern": VARIOUS_GENRES_TEMPLATE}, "user", True]]},
                                        {"subtopic": "alexa_music",
                                         "cond": [[{"pattern": MUSIC_REQUEST_RE}, "user", True]]},
                                        {"subtopic": "various_music_types",
                                         "cond": [[{"pattern": music_linkto}, "bot", True]]},
                                        {"subtopic": "what_music",
                                         "cond": [[{"pattern": "(music|song)"}, "user", True]]},
                                        {"subtopic": "all_kinds_music",
                                         "cond": [["any"]]}],
             "smalltalk": [{"utt": ["I'm always happy to have a conversation with such a wonderful person!",
                                    "You have an amazing music taste!"],
                            "subtopic": "all_kinds_music",
                            "expected_subtopic_info": [{"subtopic": "relaxing_music",
                                                        "cond": [["is_no", "user", False]]}]},
                           {"utt": ["I'm a music lover too! What music is in your playlist?"],
                            "subtopic": "what_music",
                            "expected_entities": ["genre", "singer", "group", "song"],
                            "expected_subtopic_info": ["genres", "singer", "group", "song",
                                                       "my_music", "various_genres"
                                                       ]},
                           {"utt": ["Brilliant! I like this genre too!",
                                    "What singers or bands are in your playlist?"],
                            "subtopic": "various_genres",
                            "expected_entities": ["singer", "group", "song"]},
                           {"utt": ["Yes, I like {user_genre}!",
                           ...
                           {"utt": ["Do you listen music in headphones or on a portable speaker?"],
                            "next_ackn": [{"cond": [[{"pattern": "(head|phones)"}, "user", True]],
                                           "answer": "Great! Headphones enhance the thrill of music."},
                                          {"cond": [[{"pattern": "speaker"}, "user", True]],
                                           "answer": "Great! A speaker helps to share your favourite tracks "
                                                     "with your friends."}]},
                           {"utt": ["Do you play any musical instrument?"],
                            "next_ackn": [{"cond": [["is_yes", "user", True],
                                          ...
                                          {"cond": [["is_no", "user", True]],
                                           "answer": "Ok! It's never late to try!"}]},
                           ...
                           {"utt": ["I'm sorry, i do not have this function. But I am a music lover too!",
                                    "I can tell you about some relaxing music, should I?"],
                            "subtopic": "alexa_music",
                            "expected_subtopic_info": [{"subtopic": "relaxing_music",
                                                        "cond": [["is_no", "user", False]]}]},
                           {"utt": ["Cool! I am a music lover too!",
                           ...
                           {"utt": ["There are a lot of compilations of relaxing music on Youtube.",
                            ...
                            "expected_subtopic_info": [{"subtopic": "more_relaxing_music",
                                                        "cond": [["is_yes", "user", True]]}]
                            },
                           {"utt": ["You can listen to sound of nature, for example birdsong or the sounds of sea.",
                            ...
                            "next_ackn": [{"cond": [["is_yes", "user", True]],
                                           "answer": "Me too! I like to dream listening sounds of rain."}]}
                           ],
             ...
             "expected_entities_info": {"genre": {"name": "user_genre",
                                                  "entity_substr": [["pop", "(\\bpop|popular music)"],
                                        ...
                                        "singer": {"name": "user_singer",
                                                   "wiki_parser_types": ["Q488205", "Q36834", "Q177220", "Q753110"],
                                                   "relations": ["genre", "songs", "albums", "part of"]},
                                        "group": {"name": "user_group", "wiki_parser_types": ["Q105756498", "Q215380"],
                                                  "relations": ["genre", "songs", "albums", "has part"]},
                                        "song": {"name": "user_song", "wiki_parser_types": ["Q207628"],
                                                 "relations": ["genre", "performer", "part of"]}
                                        },
             "expected_subtopics": {"genres": {"subtopic": "discuss_genre",
                                               "cond": [[{"pattern": GENRES_TEMPLATE}, "user", True]]},
                                    "singer": {"subtopic": "discuss_singer",
                                               "cond": [[{"wiki_parser_types":
                                                          ["Q488205", "Q36834", "Q177220", "Q753110"]},
                                                         "user", True]]},
                                    "group": {"subtopic": "discuss_group",
                                              "cond": [[{"wiki_parser_types": ["Q105756498", "Q215380"]},
                                                        "user", True]]},
                                    "song": {"subtopic": "discuss_song",
                                             "cond": [[{"wiki_parser_types": ["Q207628"]}, "user", True]]},
                                    "pop": {"subtopic": "pop",
                                    ...
                                    "rap": {"subtopic": "rap",
                                            "cond": [[{"user_info": {"user_genre": "rap"}}, "user", True],
                                                     [{"entity_triplets": ["user_singer", "genre",
                                                                           ["rap", "hip hop"]]},
                                                      "user", True]]},
                                    "my_music": {"subtopic": "my_music",
                                                 "cond": [[{"pattern": "(what|which) (music )?(do )?you "
                                                                       "(like|enjoy)"},
                                                           "user", True]]},
                                    "various_genres": {"subtopic": "various_genres",
                                                       "cond": [[{"pattern": VARIOUS_GENRES_TEMPLATE}, "user", True]]}
                                    }
             }
    }
