...
sensitive_all_topics = {"Politics", "Religion", "Sex_Profanity", "Depression", "Inappropriate_Content", "Disasters"}
...
def is_sensitive_topic_and_request(annotated_uttr):
    ...
    sensitive_topics_detected = any([t in sensitive_all_topics for t in topics])
