...
from common.speech_functions.generic_responses import sys_response_to_speech_function_request \
    as generic_responses_intent
from common.dialogflow_framework.extensions import intents, providers, custom, custom_functions, priorities, \
    generic_responses
from common.dialogflow_framework.stdm.key_words import TRANSITIONS, GLOBAL_TRANSITIONS, GRAPH, RESPONSE, \
    PROCESSING, forward, previous
...
flows = {
    "art": {
        ...
        GRAPH: {
            "drawing_q": {
                ...
                TRANSITIONS: {
                    ("drawing", "what_painter", priorities.middle):
                        [any, [intents.yes_intent, templates.LIKE_PATTERN,
            ...
            "photo_q": {
                ...
                TRANSITIONS: {
                    ("photo", "what_photos"): [any, [intents.yes_intent, templates.LIKE_PATTERN]]
                }
            }
        },
    },
    "drawing": {
        ...
        GRAPH: {
            ...
            "what_paintings": {
                ...
                PROCESSING: [custom_functions.entities(user_fav_painter="wiki:Q1028181"),
    ...
    "facts": {
        ...
        GRAPH: {"how_to_draw": {RESPONSE: providers.fact_provider("wikiHow", "Improve-Your-Drawing-Skills"),
