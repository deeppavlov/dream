...
class PQConv2d(nn.Module):
    """
    Quantized counterpart of nn.Conv2d modules. Stores the centroid, the assignments
    ...
    Remarks:
        - We refer the reader to the official documentation of the nn.Conv2d modules
          for the other arguments and the behavior of the modules.
        - Performance tests on GPU show that this implementation is 10% slower than
          the non-quantized nn.Conv2d modules for a standard training loop.
