...
class PQEmbedding(nn.Module):
    """
    Quantized counterpart of nn.Embedding modules. Stores the centroids and
    ...
    Remarks:
        - We refer the reader to the official documentation of the nn.Embedding modules
        ...
        - Performance tests on GPU show that this implementation is 10% slower than
          the non-quantized nn.Embedding modules for a standard training loop.
    """
