...
class BaseFairseqModel(nn.Module):
    ...
    def load_state_dict(
        ...
        """Copies parameters and buffers from *state_dict* into this modules and
        its descendants.
    ...
    def upgrade_state_dict_named(self, state_dict, name):
        ...
        Args:
            ...
            name (str): the state dict key corresponding to the current modules
        """
    ...
    def make_generation_fast_(self, **kwargs):
        ...
        def apply_remove_weight_norm(module):
            ...
            except (AttributeError, ValueError):  # this modules didn't have weight norm
                return
