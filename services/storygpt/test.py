...
def test_respond():
    ...
    c1 = ['neil wanted play', 'borrowed gear friends', 'geared headed rink',
          'practiced days', 'competition']
    c2 = ['rosie teacher birthday', 'rosie money buy', 'asked grandmother teach',
          'painted watercolor', 'rosie gift']
    contexts = [[c1], [c2]]
    s1 = "Neil had always wanted to play hockey. He borrowed his gear from his friends and used " \
         ...
         "the competition!"
    s2 = "Rosaie's teacher took her to her birthday party. Rosie didn't have enough money to buy her " \
