...
def dff_share_problems_skill_formatter(dialog: Dict) -> List[Dict]:
    return utils.dff_formatter(dialog, "dff_share_problems_skill")


def dff_book_recommendation_skill_formatter(dialog: Dict) -> List[Dict]:
    return utils.dff_formatter(dialog, "dff_book_recommendation_skill")


def dff_series_recommendation_skill_formatter(dialog: Dict) -> List[Dict]:
...
def dff_test_bot_skill_formatter(dialog: Dict) -> List[Dict]:
    return utils.dff_formatter(dialog, "dff_test_bot_skill")


def dff_travel_recommendation_skill_formatter(dialog: Dict) -> List[Dict]:
    return utils.dff_formatter(dialog, "dff_travel_recommendation_skill")


def dff_have_fun_skill_formatter(dialog: Dict) -> List[Dict]:
    return utils.dff_formatter(dialog, "dff_have_fun_skill")
