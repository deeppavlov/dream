...
function dockercompose_cmd() {
    ...
    # else
        DOCKER_COMPOSE_CMD="docker-compose --no-ansi -p dream -f docker-compose.yml -f assistant_dists/deeppavlov_assistant/docker-compose.override.yml -f assistant_dists/deeppavlov_assistant/test.yml -f assistant_dists/deeppavlov_assistant/proxy.yml"
    # fi
