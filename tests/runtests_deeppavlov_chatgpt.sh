...
function dockercompose_cmd() {
    ...
    # else
        DOCKER_COMPOSE_CMD="docker-compose --no-ansi -p test -f docker-compose.yml -f assistant_dists/deeppavlov_assistant/docker-compose.override.yml -f assistant_dists/deeppavlov_assistant/test.yml"
    # fi
