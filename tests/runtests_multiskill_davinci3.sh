...
function dockercompose_cmd() {
    ...
    # else
        DOCKER_COMPOSE_CMD="docker-compose --no-ansi -p dream -f docker-compose.yml -f assistant_dists/multiskill_ai_assistant/docker-compose.override.yml -f assistant_dists/multiskill_ai_assistant/test.yml -f assistant_dists/multiskill_ai_assistant/proxy.yml"
    # fi
