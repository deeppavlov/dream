...
flows = {
    ...
    "story_flow": {
        ...
        "gpt_story_first_part": {
            ...
            TRANSITIONS: {"gpt_story_second_part": cnd.neg(int_cnd.is_no_vars), "fallback_node": int_cnd.is_no_vars},
        },
        "gpt_story_second_part": {
            RESPONSE: loc_rsp.generate_second_prompt_part,
            TRANSITIONS: {"suggest_more": loc_cnd.prev_is_story, "fallback_node": cnd.neg(loc_cnd.prev_is_story)},
        },
        "gpt_keyword_story": {
