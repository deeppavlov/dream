...
def respond():
    ...
    # import common.test_utils as t_utils; t_utils.save_to_test(request.json,"tests/test_food_in.json",indent=4)
    responses = handler(request.json)
    # next commented line for test creating
    # import common.test_utils as t_utils; t_utils.save_to_test(responses,"tests/test_food_out.json",indent=4)
