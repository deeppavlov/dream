...
ENVVARS_TO_SEND = {
    ...
    "http://openai-api-chatgpt:8145/respond": ["OPENAI_API_KEY", "OPENAI_ORGANIZATION", "CONFIG"],
    "http://openai-api-chatgpt-16k:8167/respond": ["OPENAI_API_KEY", "OPENAI_ORGANIZATION", "CONFIG"],
    "http://openai-api-davinci3:8131/respond": ["OPENAI_API_KEY", "OPENAI_ORGANIZATION", "CONFIG"],
    "http://openai-api-gpt4:8159/respond": ["OPENAI_API_KEY", "OPENAI_ORGANIZATION", "CONFIG"],
    "http://openai-api-gpt4-32k:8160/respond": ["OPENAI_API_KEY", "OPENAI_ORGANIZATION", "CONFIG"],
    "http://openai-api-gpt4-turbo:8180/respond": ["OPENAI_API_KEY", "OPENAI_ORGANIZATION", "CONFIG"],
