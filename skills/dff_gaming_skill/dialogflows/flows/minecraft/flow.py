    ...
    MinecraftState.USR_ASK_USER_WHEN_HE_STARTED_TO_PLAY_MINECRAFT,
    {
        MinecraftState.SYS_USER_TELLS_WHEN_HE_STARTED_TO_PLAY_MINECRAFT:
            partial(
                ...
                additional_check=lambda n, v:
                    len(MINECRAFT_HOW_TOS) - len(state_utils.get_shared_memory(v).get("used_how_to_indices", [])) >= 1
            ),
...
simplified_dialogflow.set_error_successor(
    MinecraftState.SYS_USER_WANTS_TO_KNOW_HOW_TO, MinecraftState.SYS_ERR)
##############################################################
simplified_dialogflow.add_user_serial_transitions(
    MinecraftState.USR_TELL_HOW_TO_AND_ASK_USER_IF_IT_WAS_INTERESTING,
    {
...
simplified_dialogflow.set_error_successor(
    MinecraftState.SYS_BOT_CANNOT_GIVE_MORE_HOW_TOS, MinecraftState.SYS_ERR)
##############################################################
simplified_dialogflow.add_system_transition(
...
simplified_dialogflow.set_error_successor(
    MinecraftState.SYS_BOT_WILL_GIVE_ANOTHER_HOW_TO, MinecraftState.SYS_ERR)
##############################################################
simplified_dialogflow.add_user_serial_transitions(
    MinecraftState.USR_ASK_IF_USER_WANTS_TO_KNOW_HOW_TO,
    {
