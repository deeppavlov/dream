...
def process(dialog, gold_list, banned_words, ner_model):
    ...
    for i in range(len(utterances) - 1):
        ...
        print('**')
        print(utterances[i])
        banned_skills = ['dummy_skill', 'meta_script_skill', 'comet_dialog_skill', 'book_skill', 'tfidf_retrieval']
        if utterances[i] != '':
...
def main():
    ...
    banned_words = ['my unknown', 'unknown is', 'INTERJECTION', 'no_', 'NO_ANSWER']
