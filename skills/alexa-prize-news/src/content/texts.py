...
CHOOSE_SUBTOPIC = (lambda topic, subtopics_list: f"Among the latest news in {topic}, "
                                                 f"I can identify several areas:\n\n{subtopics_list}"
                                                 f"Which one would you like to know about?")

WRONG_SUBTOPIC = ON_INVALID_COMMAND + "Choose a subtopic by its number, key phrases, \
