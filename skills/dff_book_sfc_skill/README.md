...
In this version, you can see how conditions based on speech functions can be used for transition to desired nodes.
Here is a list of all speech functions available for use in this version:
