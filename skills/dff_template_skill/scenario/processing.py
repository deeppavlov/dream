...
get_genre_regexp: Callable[[Context, Actor], Context] = save_to_slots(
    "cur_genre"
)(universal.get_genre_regexp)

get_book_genre: Callable[[Context, Actor], Context] = save_to_slots(
    "cur_genre"
...
about_bookreads: Callable[[Context, Actor], Context] = save_to_slots(
    "cur_book_about"
)(universal.about_bookreads)

about_wiki: Callable[[Context, Actor], Context] = save_to_slots(
    "cur_book_about"
...
get_book_year: Callable[[Context, Actor], Context] = save_to_slots(
    "cur_book_ago"
