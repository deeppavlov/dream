...
from df_engine.core.keywords import GLOBAL, PROCESSING, RESPONSE, TRANSITIONS, MISC
...
plot = {
    GLOBAL: {
        TRANSITIONS: {
            ("beatles", "beatles_q", 1.2): cnd.regexp(r"\bbeatles\b", re.I),
            lbl.previous(1.2): cnd.regexp(r".*(sorry)|(repeat)|(go\sback)|(previous).*", re.I),
            ...
            ("album", "sgt_peppers", 1.2): loc_cnd.wants_to_see(item_name="Sgt. Pepper's Lonely Hearts Club Band"),
            ...
            ("instruments", "guitar_paul_1", 1.2): loc_cnd.wants_to_see(
                item_name=["zenith", "paul's guitar", "mccartney's guitar"]
            ),
            ...
            ("beatles_reset", "sorry_reset", 1.2): cnd.regexp(
                r"((.*i\swant\sto\ssee\s)|(.*go\sto.*)|"
                r"(.*i\swanna\ssee\s)|(.*\slook\sat\s)|"
                r"(.*show\sme\s)|(.*tell\sme))",
                re.I,
            ),
        }
    },
    "beatles": {
        ...
        "instruments_q": {
            ...
            TRANSITIONS: {
                # lbl.previous(): cnd.regexp(r".*(sorry)|(repeat)|(go\sback)|(previous).*", re.I),
    ...
    "history": {
        ...
        "drummer_wrong": {
            ...
            TRANSITIONS: {
                # lbl.previous(): cnd.regexp(r".*(sorry)|(repeat)|(go\sback)|(previous).*", re.I),
                ("album", "what_album"): loc_cnd.move_on,
                ("album", "what_album", 0.99): cnd.true(),
            },
        },
        "drummer_right": {
    ...
    "album": {
        "what_album": {
            ...
            PROCESSING: {"add_node_name": loc_prs.add_node_name(name="what_album")},
            TRANSITIONS: {
                # lbl.previous(): cnd.regexp(r".*(sorry)|(repeat)|(go\sback)|(previous).*", re.I),
                ...
                ("album", "please_please_me", 0.99): cnd.true(),
            },
        },
        "what_album_res": {
        ...
        "please_please_me": {
            ...
            PROCESSING: {
                "increment_album_counter": loc_prs.increment_album_counter,
                "slot_filling_albums": loc_prs.slot_filling_albums,
                "add_misc_to_response": loc_prs.add_misc_to_response,
                "add_node_name": loc_prs.add_node_name("Please Please Me"),
            },
            TRANSITIONS: {
                # lbl.previous(): cnd.regexp(r".*(sorry)|(repeat)|(go\sback)|(previous).*", re.I),
        ...
        "with_the_beatles": {
            ...
            PROCESSING: {
                ...
                "slot_filling_albums": loc_prs.slot_filling_albums,
                "add_misc_to_response": loc_prs.add_misc_to_response,
                "add_node_name": loc_prs.add_node_name("With The Beatles"),
            },
            TRANSITIONS: {
                # lbl.previous(): cnd.regexp(r".*(sorry)|(repeat)|(go\sback)|(previous).*", re.I),
                ("song", "song_q", 0.2): loc_cnd.move_on,
        ...
        "a_hard_days_night_corr": {
            ...
            PROCESSING: {
                ...
                "slot_filling_albums": loc_prs.slot_filling_albums,
                "add_misc_to_response": loc_prs.add_misc_to_response,
                "add_node_name": loc_prs.add_node_name("Hard Day's Night"),
            },
            TRANSITIONS: {
                # lbl.previous(): cnd.regexp(r".*(sorry)|(repeat)|(go\sback)|(previous).*", re.I),
                ("song", "song_q", 0.2): loc_cnd.move_on,
        ...
        "beatles_for_sale": {
            ...
            PROCESSING: {
                ...
                "slot_filling_albums": loc_prs.slot_filling_albums,
                "add_misc_to_response": loc_prs.add_misc_to_response,
                "add_node_name": loc_prs.add_node_name("Beatles For Sale"),
            },
            TRANSITIONS: {
                # lbl.previous(): cnd.regexp(r".*(sorry)|(repeat)|(go\sback)|(previous).*", re.I),
                ("song", "song_q", 0.2): loc_cnd.move_on,
        ...
        "help": {
            ...
            PROCESSING: {
                ...
                "slot_filling_albums": loc_prs.slot_filling_albums,
                "add_misc_to_response": loc_prs.add_misc_to_response,
                "add_node_name": loc_prs.add_node_name("Help"),
            },
            TRANSITIONS: {
                # lbl.previous(): cnd.regexp(r".*(sorry)|(repeat)|(go\sback)|(previous).*", re.I),
                ("song", "song_q", 0.2): loc_cnd.move_on,
        ...
        "rubber_soul": {
            ...
            PROCESSING: {
                ...
                "slot_filling_albums": loc_prs.slot_filling_albums,
                "add_misc_to_response": loc_prs.add_misc_to_response,
                "add_node_name": loc_prs.add_node_name("Rubber Soul"),
            },
            TRANSITIONS: {
                # lbl.previous(): cnd.regexp(r".*(sorry)|(repeat)|(go\sback)|(previous).*", re.I),
                ("song", "song_q", 0.2): loc_cnd.move_on,
        ...
        "revolver": {
            ...
            PROCESSING: {
                ...
                "slot_filling_albums": loc_prs.slot_filling_albums,
                "add_misc_to_response": loc_prs.add_misc_to_response,
                "add_node_name": loc_prs.add_node_name("Revolver"),
            },
            TRANSITIONS: {
                # lbl.previous(): cnd.regexp(r".*(sorry)|(repeat)|(go\sback)|(previous).*", re.I),
                ("song", "song_q", 0.2): loc_cnd.move_on,
        ...
        "yellow_submarine": {
            ...
            PROCESSING: {
                ...
                "slot_filling_albums": loc_prs.slot_filling_albums,
                "add_misc_to_response": loc_prs.add_misc_to_response,
                "add_node_name": loc_prs.add_node_name("Yellow Submarine"),
            },
            TRANSITIONS: {
                # lbl.previous(): cnd.regexp(r".*(sorry)|(repeat)|(go\sback)|(previous).*", re.I),
                ("song", "song_q", 0.2): loc_cnd.move_on,
        ...
        "sgt_peppers": {
            ...
            PROCESSING: {
                ...
                "slot_filling_albums": loc_prs.slot_filling_albums,
                "add_misc_to_response": loc_prs.add_misc_to_response,
                "add_node_name": loc_prs.add_node_name("Sgt. Pepper's Lonely Hearts Club Band"),
            },
            TRANSITIONS: {
                # lbl.previous(): cnd.regexp(r".*(sorry)|(repeat)|(go\sback)|(previous).*", re.I),
                ("song", "song_q", 0.2): loc_cnd.move_on,
        ...
        "white_album": {
            ...
            PROCESSING: {
                ...
                "slot_filling_albums": loc_prs.slot_filling_albums,
                "add_misc_to_response": loc_prs.add_misc_to_response,
                "add_node_name": loc_prs.add_node_name("White Album"),
            },
            TRANSITIONS: {
                # lbl.previous(): cnd.regexp(r".*(sorry)|(repeat)|(go\sback)|(previous).*", re.I),
                ("song", "song_q", 0.2): loc_cnd.move_on,
        ...
        "abbey_road": {
            ...
            PROCESSING: {
                ...
                "slot_filling_albums": loc_prs.slot_filling_albums,
                "add_misc_to_response": loc_prs.add_misc_to_response,
                "add_node_name": loc_prs.add_node_name("Abbey Road"),
            },
            TRANSITIONS: {
                # lbl.previous(): cnd.regexp(r".*(sorry)|(repeat)|(go\sback)|(previous).*", re.I),
                ("song", "song_q", 0.2): loc_cnd.move_on,
        ...
        "let_it_be": {
            ...
            PROCESSING: {
                ...
                "slot_filling_albums": loc_prs.slot_filling_albums,
                "add_misc_to_response": loc_prs.add_misc_to_response,
                "add_node_name": loc_prs.add_node_name("Let It Be"),
            },
            TRANSITIONS: {
                # lbl.previous(): cnd.regexp(r".*(sorry)|(repeat)|(go\sback)|(previous).*", re.I),
                ("song", "song_q", 0.2): loc_cnd.move_on,
    ...
    "photos": {
        "photos_q": {
            ...
            PROCESSING: {"add_node_name": loc_prs.add_node_name(name="photos_q")},
            TRANSITIONS: {
        ...
        "abbey_road": {
            ...
            PROCESSING: {
                "add_misc_to_response": loc_prs.add_misc_to_response,
                "add_node_name": loc_prs.add_node_name(name="abbey_road"),
            },
            TRANSITIONS: {
                ("what_is_next", "cur_photos"): cnd.regexp(r"\bwhat's\snext\b", re.I),
        ...
        "fact_ar": {
            ...
            """of the car...""",
            PROCESSING: {"add_node_name": loc_prs.add_node_name(name="fact_ar")},
            TRANSITIONS: {
                ("what_is_next", "cur_photos"): cnd.regexp(r"\bwhat's\snext\b", re.I),
        ...
        "info_ar": {
            ...
            PROCESSING: {"add_node_name": loc_prs.add_node_name(name="info_ar")},
            TRANSITIONS: {
                ("what_is_next", "cur_photos"): cnd.regexp(r"\bwhat's\snext\b", re.I),
                ("photos", "yesterday&today"): cnd.true(),
            },
        ...
        "yesterday&today": {
            ...
            PROCESSING: {"add_misc_to_response": loc_prs.add_misc_to_response},
            TRANSITIONS: {("what_is_next", "cur_last_photo"): cnd.regexp(r"\bwhat's\snext\b", re.I)},
    ...
    "song": {
        ...
        "fav_song": {
            ...
            PROCESSING: {
                "extract_song_id": loc_prs.extract_song_id,
                "add_misc_to_response": loc_prs.add_misc_to_response,
            },
            TRANSITIONS: {
                ("what_is_next", "cur_songs"): cnd.regexp(r"\bwhat's\snext\b", re.I),
    ...
    "people": {
        "fact_lennon": {
            ...
            PROCESSING: {
                "extract_members": loc_prs.extract_members,
                "fill_slots": loc_prs.fill_slots,
                "add_misc_to_response": loc_prs.add_misc_to_response,
            },
            TRANSITIONS: {
                ("what_is_next", "cur_band"): cnd.regexp(r"\bwhat's\snext\b", re.I),
    ...
    "instruments": {
        "play_q": {
            ...
            PROCESSING: {"add_node_name": loc_prs.add_node_name(name="play_q")},
            TRANSITIONS: {
        ...
        "play_q_res": {
            ...
            PROCESSING: {"add_node_name": loc_prs.add_node_name(name="play_q_res")},
            TRANSITIONS: {
        ...
        "guitar_paul_1": {
            ...
            "Isn't it beautiful?",
            PROCESSING: {
                "extract_inst": loc_prs.extract_inst,
                "fill_slots": loc_prs.fill_slots,
                "add_misc_to_response": loc_prs.add_misc_to_response,
                "add_node_name": loc_prs.add_node_name(name="play_q_res"),
            },
            TRANSITIONS: {
                ("what_is_next", "cur_instruments"): cnd.regexp(r"\bwhat's\snext\b", re.I),
        ...
        "guitar_paul_2": {
            ...
            PROCESSING: {
                "add_misc_to_response": loc_prs.add_misc_to_response,
                "add_node_name": loc_prs.add_node_name(name="guitar_paul_2"),
            },
            TRANSITIONS: {
                ("what_is_next", "cur_instruments"): cnd.regexp(r"\bwhat's\snext\b", re.I),
        ...
        "guitar_lennon": {
            ...
            PROCESSING: {
                "add_misc_to_response": loc_prs.add_misc_to_response,
                "add_node_name": loc_prs.add_node_name(name="guitar_lennon"),
            },
            TRANSITIONS: {
                ("what_is_next", "cur_instruments"): cnd.regexp(r"\bwhat's\snext\b", re.I),
    ...
    "what_is_next": {
        "cur_album": {
            ...
            TRANSITIONS: {
                ...
                ("album", "please_please_me"): cnd.all(
                    [loc_cnd.is_next(album_name="what_album"), cnd.regexp(r"\b(continue)|(albums)\b", re.I)]
                ),
                ("album", "please_please_me", 0.99): cnd.all(
                    [loc_cnd.is_next(album_name="Let It Be"), cnd.regexp(r"\b(continue)|(albums)\b", re.I)]
                ),
                ("album", "with_the_beatles"): cnd.all(
                    [loc_cnd.is_next(album_name="Please Please Me"), cnd.regexp(r"\b(continue)|(albums)\b", re.I)]
                ),
                ("album", "a_hard_days_night_wrong"): cnd.all(
                    [loc_cnd.is_next(album_name="With The Beatles"), cnd.regexp(r"\b(continue)|(albums)\b", re.I)]
                ),
                ("album", "beatles_for_sale"): cnd.all(
                    [loc_cnd.is_next(album_name="Hard Day's Night"), cnd.regexp(r"\b(continue)|(albums)\b", re.I)]
                ),
                ("album", "help"): cnd.all(
                    [loc_cnd.is_next(album_name="Beatles For Sale"), cnd.regexp(r"\b(continue)|(albums)\b", re.I)]
                ),
                ("album", "rubber_soul"): cnd.all(
                    [loc_cnd.is_next(album_name="Help"), cnd.regexp(r"\b(continue)|(albums)\b", re.I)]
                ),
                ("album", "revolver"): cnd.all(
                    [loc_cnd.is_next(album_name="Rubber Soul"), cnd.regexp(r"\b(continue)|(albums)\b", re.I)]
                ),
                ("album", "yellow_submarine"): cnd.all(
                    [loc_cnd.is_next(album_name="Revolver"), cnd.regexp(r"\b(continue)|(albums)\b", re.I)]
                ),
                ("album", "sgt_peppers"): cnd.all(
                    [loc_cnd.is_next(album_name="Yellow Submarine"), cnd.regexp(r"\b(continue)|(albums)\b", re.I)]
                ),
                ("album", "white_album"): cnd.all(
                    [
                        loc_cnd.is_next(album_name="Sgt. Pepper's Lonely Hearts Club Band"),
                        cnd.regexp(r"\b(continue)|(albums)\b", re.I),
                    ]
                ),
                ("album", "abbey_road"): cnd.all(
                    [loc_cnd.is_next(album_name="White Album"), cnd.regexp(r"\b(continue)|(albums)\b", re.I)]
                ),
                ("album", "let_it_be"): cnd.all(
                    [loc_cnd.is_next(album_name="Abbey Road"), cnd.regexp(r"\b(continue)|(albums)\b", re.I)]
                ),
            },
        },
        "cur_history": {
        ...
        "cur_instruments": {
            ...
            TRANSITIONS: {
                ...
                ("instruments", "guitar_paul_2"): cnd.all(
                    [loc_cnd.is_next(album_name="guitar_paul_1"), cnd.regexp(r"\b(continue)|(instruments)\b", re.I)]
                ),
                ("instruments", "guitar_lennon"): cnd.all(
                    [loc_cnd.is_next(album_name="guitar_paul_2"), cnd.regexp(r"\b(continue)|(instruments)\b", re.I)]
                ),
                ("instruments", "drum_kit"): cnd.all(
                    [loc_cnd.is_next(album_name="guitar_lennon"), cnd.regexp(r"\b(continue)|(instruments)\b", re.I)]
                ),
        ...
        "cur_photos": {
            ...
            TRANSITIONS: {
                ("photos", "abbey_road", 1): cnd.all(
                    [loc_cnd.is_next(album_name="photos_q"), cnd.regexp(r"\b(continue)|(photos)\b", re.I)]
                ),
                ("photos", "yesterday&today", 0.9): cnd.all(
                    [loc_cnd.is_next(album_name="abbey_road"), cnd.regexp(r"\b(continue)|(photos)\b", re.I)]
                ),
                ("photos", "yesterday&today", 0.8): cnd.all(
                    [loc_cnd.is_next(album_name="fact_ar"), cnd.regexp(r"\b(continue)|(photos)\b", re.I)]
                ),
                ("photos", "yesterday&today", 0.7): cnd.all(
                    [loc_cnd.is_next(album_name="info_ar"), cnd.regexp(r"\b(continue)|(photos)\b", re.I)]
                ),
            },
        },
        "cur_last_photo": {
