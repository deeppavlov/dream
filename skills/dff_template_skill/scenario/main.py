...
flows = {
    GLOBAL: {
        TRANSITIONS: {
            ...
            ("concrete_book_flow", "offer_fact", 1.2): cnd.all(
                [
                    cnd.any([loc_cnd.is_last_used_phrase(loc_rsp.ALL_QUESTIONS_ABOUT_BOOK), loc_cnd.about_book]),
    ...
    "books_general": {
        ...
        "book_restart": {
            RESPONSE: loc_rsp.append_unused(
                initial="Speaking of books, ", phrases=loc_rsp.QUESTIONS_ABOUT_BOOKS, exit_on_exhaust=True
            ),
            PROCESSING: {
    ...
    "bot_fav_book": {
        "fav_name": {
            ...
            PROCESSING: {
                1: loc_prs.save_next_key(fav_keys, loc_rsp.FAVOURITE_BOOK_ATTRS),
        ...
        "fav_denied": {
            ...
            PROCESSING: {1: loc_prs.set_flag("denied_favorite", True), 2: int_prs.set_confidence(BIT_LOWER_CONFIDENCE)},
            TRANSITIONS: {
    ...
    "concrete_book_flow": {
        ...
        "ask_fav": {
            ...
            PROCESSING: {1: loc_prs.set_flag("user_fav_book_visited", True), 2: loc_prs.execute_response},
            TRANSITIONS: {
        ...
        "user_fav": {
            ...
            PROCESSING: {1: loc_prs.get_book, 2: loc_prs.set_flag("user_fav_book_visited", True)},
            TRANSITIONS: {("concrete_book_flow", "denied_information", 1.6): cnd.true()},
        },
        "ask_opinion": {
        ...
        "user_liked": {
            ...
            PROCESSING: {1: int_prs.set_confidence(SUPER_CONFIDENCE)},
        },
        "user_disliked": {
        ...
        "offer_fact": {
            ...
            PROCESSING: {1: loc_prs.get_book, 2: loc_prs.about_bookreads, 3: loc_prs.about_wiki, 4: loc_prs.get_movie},
            TRANSITIONS: {
                ("tell_about", 2): loc_cnd.check_slot("cur_book_about"),
                ("tell_movie", 1.9): cnd.all(
                    [loc_cnd.check_slot("cur_book_movie"), loc_cnd.check_slot("cur_book_director")]
                ),
        ...
        "tell_about": {
            ...
            PROCESSING: {1: loc_prs.get_book_year, 2: loc_prs.execute_response, 3: int_prs.fill_responses_by_slots()},
            TRANSITIONS: {
        ...
        "offer_date": {
            RESPONSE: loc_rsp.append_unused(
                initial="I've read it. It's an amazing book! ", phrases=[loc_rsp.WHEN_IT_WAS_PUBLISHED]
            ),
            PROCESSING: {1: loc_prs.get_book, 2: loc_prs.get_book_year, 3: loc_prs.execute_response},
            TRANSITIONS: {
                ("concrete_book_flow", "tell_date", 2): cnd.all(
                    [int_cnd.is_yes_vars, loc_cnd.check_slot("cur_book_ago")]
                ),
    ...
    "genre_flow": {
        LOCAL: {PROCESSING: {1: int_prs.set_confidence(DEFAULT_CONFIDENCE)}},
        "tell_phrase": {
        ...
        "not_read_genrebook": {
            RESPONSE: loc_rsp.append_unused(
                initial=random.choice(loc_rsp.READ_BOOK_ADVICES) + " ", phrases=[loc_rsp.TELL_REQUEST]
            ),
            PROCESSING: {1: loc_prs.execute_response},
            TRANSITIONS: {
                lbl.forward(): cnd.all([int_cnd.is_yes_vars, loc_cnd.about_in_slots]),
        ...
        "bot_fav": {
            RESPONSE: loc_rsp.genre_phrase,
            PROCESSING: {
                1: int_prs.save_slots_to_ctx({"cur_genre", random.choice(list(loc_rsp.GENRE_PHRASES.keys()))})
            },
        },
    },
    "bible_flow": {
    ...
    "undetected_flow": {
        LOCAL: {
            PROCESSING: {1: int_prs.set_confidence(BIT_LOWER_CONFIDENCE)},
        },
        "ask_to_repeat": {
            RESPONSE: "Oops, I'm afraid I couldn't make out what you've just said. Can you, please, repeat?",
            TRANSITIONS: {lbl.forward(1): cnd.true()},
        },
        "change_branch": {
