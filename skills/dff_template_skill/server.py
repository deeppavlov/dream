...
def respond():
    import common.test_utils as t_utils; t_utils.save_to_test(request.json,"tests/intent_cant_do_in.json",indent=4)  # TEST
    responses = handler(request.json, RANDOM_SEED)  # TEST
    import common.test_utils as t_utils; t_utils.save_to_test(responses,"tests/intent_cant_do_out.json",indent=4)  # TEST
