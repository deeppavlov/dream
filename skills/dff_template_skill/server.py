...
def respond():
    import common.test_utils as t_utils; t_utils.save_to_test(request.json,"tests/country_stats_in.json",indent=4)  # TEST
    responses = handler(request.json, RANDOM_SEED)  # TEST
    import common.test_utils as t_utils; t_utils.save_to_test(responses,"tests/country_stats_out.json",indent=4)  # TEST
