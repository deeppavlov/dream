...
import dialogflows.flows.music as music_flow
...
composite_dialogflow.add_component(music_flow.dialogflow, scopes.MUSIC)
...
for node in [scopes.State.USR_ROOT, scopes.State.USR_ERR]:
    simplified_dialogflow.add_user_serial_transitions(
        node,
        {(scopes.MUSIC, music_flow.State.USR_START): music_request},
    )
