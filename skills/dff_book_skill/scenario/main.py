...
flows = {
    ...
    "bot_fav_book": {
        "fav_name": {
            ...
            TRANSITIONS: {
                ...
                ("bot_fav_book", "fav_denied", 5): int_cnd.is_no_vars,
    ...
    "concrete_book_flow": {
        ...
        "user_liked": {
            ...
            TRANSITIONS: {
                ("concrete_book_flow", "denied_information", 5): int_cnd.is_no_vars,
        ...
        "denied_information": {
            ...
            TRANSITIONS: {("bible_flow", "bible_start", 5): int_cnd.is_no_vars},
        },
    },
    "genre_flow": {
        "tell_phrase": {
