...
def main_test():
    ...
    gold_phrases = ['i mainly like marvel. apparently they published a generic comic book so they could trade mark '
                    'super-hero and super-villian.',
                    "i know right, it's strange that was even an option. dc actually stands for detective comics. "
                    "i didn't know that.",
                    'they said to make the name redundant. so weird. '
                    'i thought stan lee was an amazing human, did you like him?',
                    ...
                    'i enjoyed the animated series as well as some of the new ones, '
                    'my kids and i enjoy teen titans go!',
