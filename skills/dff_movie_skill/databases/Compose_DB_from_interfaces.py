...
for url in [u'https://datasets.imdbws.com/name.basics.tsv.gz',
            u'https://datasets.imdbws.com/title.ratings.tsv.gz',
            u'https://datasets.imdbws.com/title.akas.tsv.gz',
            u'https://datasets.imdbws.com/title.basics.tsv.gz',
            u'https://datasets.imdbws.com/title.crew.tsv.gz',
            u'https://datasets.imdbws.com/title.episode.tsv.gz',
            u'https://datasets.imdbws.com/title.principals.tsv.gz',
            u'https://datasets.imdbws.com/title.episode.tsv.gz']:
...
if collect_movies_based_on_numvotes:
    ...
    movies_ids.extend(df.loc[df.loc[:, "averageRating"] > 6., "tconst"].values)
