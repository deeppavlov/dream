...
def test_one_step_responses():
    ...
    response = requests.post(url, json=input_data).json()[0]
    assert response[1:] == [1.0, {}, {}, {'bot_attitudes': [['Comedy', 'genre', 'very_positive'],
    ...
    response = requests.post(url, json=input_data).json()[0]
    assert response[1:] == [0.98, {}, {}, {"bot_attitudes": [['1798709', 'movie', 'very_positive']],
                                           "human_attitudes": []
                                           }], \
        print(response)
    ...
    response = requests.post(url, json=input_data).json()[0]
    assert response[1:] == [0.98, {}, {}, {"bot_attitudes": [['0108778', 'movie', 'very_positive']],
                                           "human_attitudes": []
                                           }], \
        print(response)
    ...
    response = requests.post(url, json=input_data).json()[0]
    assert response[1:] == [1.0, {}, {}, {'bot_attitudes': [['0080684', 'movie', 'very_positive']],
                                          'human_attitudes': []}], \
        print(response)
    ...
    response = requests.post(url, json=input_data).json()[0]
    assert response[1:] == [1.0, {}, {}, {'bot_attitudes': [['Film-noir', 'genre', 'negative'],
    ...
    response = requests.post(url, json=input_data).json()[0]
    assert response[1:] == [1.0, {}, {}, {'bot_attitudes': [['Jodie Foster', 'actor', 'very_positive']],
                                          'human_attitudes': []}], \
        print(response)
